...
public class Home extends JFrame {
    ...
    public Home(Dimension size, Runnable onBack, Runnable onPlay) {

        setTitle("Home - Bad Dopo Cream");
        setSize(size);
        ...
        Image menuScaled = panelImg.getImage().getScaledInstance(pw, ph, Image.SCALE_SMOOTH);
        JLabel panel = new JLabel(new ImageIcon(menuScaled));
